...
const descriptionText =
  'Oryy (based on Gnosis Safe) is the most trusteddigital asset management platform. Customize how you manage your crypto assets.'
const titleText = 'Oryy'
...
const MetaTags = ({ prefetchUrl }: { prefetchUrl: string }) => (
  <>
    ...
    {/* Social sharing */}
    <meta name="og:image" content="https://app.oryy.io/images/social-share.png" />
    <meta name="og:description" content={descriptionText} />
    <meta name="og:title" content={titleText} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@flrfinance" />
    <meta name="twitter:title" content={titleText} />
    <meta name="twitter:description" content={descriptionText} />
    <meta name="twitter:image" content="https://app.oryy.io/images/social-share.png" />
